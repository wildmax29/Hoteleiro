                    ...
                    %>
                        <form role="form" method="post" action="../Hospede">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nome_hospede"class="form-control" placeholder="Nome do hospede" >
                               
                                <p class="help-block">NOME DO HOSPEDE</p>
                            </div>

                            <div class="form-group">
                                <input name="email_hospede" class="form-control" placeholder="email@email.com">
                                <p class="help-block">EMAIL</p>
                            </div>
                             <div class="form-group">
                                <input name="cpf_hospede" class="form-control" placeholder="CPF">
